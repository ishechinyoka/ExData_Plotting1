...
## Make plot3.png in this folder:
png("plot3.png", width=480, height=480)

plot(hhp_data$date_time, hhp_data$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
lines(hhp_data$date_time, hhp_data$Sub_metering_2, col="red")
lines(hhp_data$date_time, hhp_data$Sub_metering_3, col="blue")
